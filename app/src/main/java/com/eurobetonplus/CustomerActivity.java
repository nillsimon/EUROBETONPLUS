...
public class CustomerActivity extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(auth.getCurrentUser() != null){
            startActivity(new Intent(CustomerActivity.this, CustomerMapsActivity.class));
        }
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                startActivity(new Intent(CustomerActivity.this,
                                        CustomerMapsActivity.class));
                                Toast.makeText(CustomerActivity.this,"Вы успешно вошли "+"\n" + "с адресом: "
                                        + textInputEmail.getEditText().getText().toString().trim()  + "\n" +"c именем: "
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                startActivity(new Intent(CustomerActivity.this,
                                        CustomerMapsActivity.class));
                                Toast.makeText(CustomerActivity.this,"Вы успешно зарегистрированы "+"\n" + "с адресом: "
                                        + textInputEmail.getEditText().getText().toString().trim()  + "\n" +"c именем: "
                                        + textInputName.getEditText().getText().toString().trim() + "\n"+"и паролем: "
                                        + textInputPassword.getEditText().getText().toString().trim(), Toast.LENGTH_LONG).show();
                                ...
                                // If sign in fails, display a message to the user.
                                Log.w(TAG, "createUserWithEmail:failure", task.getException());
                                Toast.makeText(CustomerActivity.this, "Такой пользователь уже зарегистрирован",
                                        Toast.LENGTH_SHORT).show();
                                // updateUI(null);
                            }
